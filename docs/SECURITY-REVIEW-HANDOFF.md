...
author/committer entries use one, 78 the other.
...
0. Six defects the audit found and did not change (each verified by an adversarial
   reader; a fix branch is in progress and will say so here when merged):
